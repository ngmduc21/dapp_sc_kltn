...
$(document).ready(function () {
    ...
    $("#showsc").click(function(){
        ...
        contractMM.methods.getOwner().call({
            from: userAccount
        }).then(function(result){
            $("#scowner").val(result)
            console.log(result)
        ...
        contractMM.methods.totalSupply().call({
            from: userAccount
        }).then(function(result){
            $("#sctotalsupply").val(result)
            console.log(result)
        });
        ...
        $("#mintbtn").click(function(){
            ...
            contractMM.methods.mint(account, amount).send({
                from: userAccount
            }).then(function (result) {
                console.log(result);
            })
        ...
        $("#burnbtn").click(function(){
            ...
            amount = $("#tokenAmount").val()
            console.log(account, amount);
            contractMM.methods.burn(account, amount).send({
                from: userAccount
            }).then(function (result) {
                console.log(result);
            })
